...
:::info[**Pengguna Windows – Harap Gunakan Git Bash**]
Pastikan kamu menjalankan perintah melalui terminal Git Bash yang terpisah dari VSCode.
Jangan gunakan terminal bawaan VSCode, CMD, atau PowerShell, karena perintah tidak akan berjalan di sana.
:::

:::info[**Silakan letakkan file ini di direktori paling atas (root folder) dari proyek kamu.**]
:::
