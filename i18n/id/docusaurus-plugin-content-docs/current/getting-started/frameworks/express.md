...
> Selain itu, hanya satu file yang dapat diunggah dalam satu waktu.  
Dukungan untuk unggah banyak file sekaligus direncanakan dalam pembaruan mendatang.
:::  
...
```
  ...
  <TabItem value='javascript' label='Javascript'>
> Kami menyarankan menggunakan **TypeScript** untuk pengalaman pengembangan yang lebih baik dan keamanan tipe yang lebih terjamin.  
Namun, **JavaScript** sepenuhnya didukung — silakan gunakan mana pun yang paling sesuai untuk Anda.  
Selamat mencoba dan semoga menyenangkan membangun dengan JavaScript!
